...
data class VehicleDocument(
    ...
    val documentType: VehicleDocumentType = VehicleDocumentType.OTHER,
    ...
    val status: VehicleDocumentStatus = VehicleDocumentStatus.ACTIVE,
    val replacesDocumentId: String? = null,
    val replacedByDocumentId: String? = null,
